...
* 
	...
	- char* sFormats[] -> const char* sFormats[]
	- char* sMonths[] -> const const char* sMonths[]
	- char* sMonths[] -> const char* sMonths[]
	- char* sSMonths[] -> const char* sSMonths[]
	- char* sDays[] -> const char* sDays[]
	- char* sSDays[] -> const char* sSDays[]
	-sDays[GetDOW()] -> (char*)sDays[GetDOW()]
*/

#include "../../../include/DataHeaders/RJM_SQLite_HandlersHeaders/RJMFTime.h"
#include <time.h>
			...
			*pIn++;
			...
			case 'j':
				...
				*pOut++;
				break;
			case 'w':
				sprintf_s(buf, "%0.1d", GetDOW());
				*pOut = buf[0];
				*pOut++;
				break;
			case 'b':
				pS2 = (char*)sSMonths[GetMonth()];
				while ((*pS2) != '\0') {
					*pOut = *pS2;
					*pOut++;
					*pS2++;
			...
			case '!':
				...
				*pOut = '.';
				*pOut++;
				sprintf_s(buf, "%0.2d", GetHdthsecond());
				*pOut = buf[0];
				*pOut++;
				*pOut = buf[1];
				*pOut++;
